// codegen:start {preset: barrel, include: ./operations/*.ts, prefix: "@effect/html/data/Interpolation"}
export * from "@effect/html/data/Interpolation/operations/instrument"
export * from "@effect/html/data/Interpolation/operations/isInterpolation"
